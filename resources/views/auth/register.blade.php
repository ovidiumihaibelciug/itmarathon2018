                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                {{--<label for="role1">User</label>&nbsp;<input type="radio" name="role" value="1" id="role1" checked> &nbsp;&nbsp;--}}
                                {{--<label for="role2">Doctor</label>&nbsp;<input type="radio" name="role" value="2" id="role2">&nbsp;&nbsp;--}}
                                {{--<label for="role3">Administrator</label>&nbsp;<input type="radio" name="role" value="3" id="role3">--}}
                            </div>
